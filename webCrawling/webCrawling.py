...
# 미구현 및 오류 : 돋보기 아이콘으로 된 파일은 아직 저장하지 못해요. -> 이것때문에 파일명이 꼬이는 경우가 있는데 조만간 수정할 예정입니다!
...
2. Chrome 창으로 뜨는 파일(돋보기) 저장 구현하기 => 출력 눌러서 pdf 저장하는 기능 이용하면 될 것 같다.
3. 중복처리... 파일명 아니까 쉬울듯 pass로 처리하거나
